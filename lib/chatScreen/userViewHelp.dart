...
class UserViewHelp extends StatefulWidget {
  const UserViewHelp({Key? key}) : super(key: key);

  @override
  State<UserViewHelp> createState() => _UserViewsState();
}

class _UserViewsState extends State<UserViewHelp> with WidgetsBindingObserver {
          ...
          children: [
            ...
            SizedBox(
              ...
              child: StreamBuilder<QuerySnapshot>(
                stream: allUsersProvider.getAllUserHelp().asStream(),
